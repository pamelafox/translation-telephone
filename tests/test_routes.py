...
def test_rounds_post(client, session):
    round_data = {"translations":[{"language":"ENGLISH","message":"seize the day!"},{"language":"MONGOLIAN","message":"тэр өдрийг нь хураан ав!"},{"language":"NORWEGIAN","message":"plukk opp dagen!"},{"language":"POLISH","message":"odbierz dzień!"},{"language":"SERBIAN","message":"Da dobijem dan!"},{"language":"WELSH","message":"I gael y diwrnod!"},{"language":"PUNJABI","message":"ਦਿਨ ਬਿਤਾਉਣ ਲਈ!"},{"language":"KAZAKH","message":"Күнді өткізу үшін!"},{"language":"KOREAN","message":"하루를 지나치려면!"},{"language":"SPANISH","message":"¡Para pasar el día!"},{"language":"AMHARIC","message":"ቀኑን ለማሳለፍ!"},{"language":"GEORGIAN","message":"დღის გასატარებლად!"},{"language":"LITHUANIAN","message":"Praleisti dieną!"},{"language":"ENGLISH","message":"Spend the day!"}],"usergen":True,"message":"seize the day!","language":"ENGLISH","endmessage":"Spend the day!"}
...
def test_rounds_post_bybot(client, session):
    round_data = {"translations":[{"language":"ENGLISH","message":"seize the day!"},{"language":"MONGOLIAN","message":"тэр өдрийг нь хураан ав!"},{"language":"NORWEGIAN","message":"plukk opp dagen!"},{"language":"POLISH","message":"odbierz dzień!"},{"language":"SERBIAN","message":"Da dobijem dan!"},{"language":"WELSH","message":"I gael y diwrnod!"},{"language":"PUNJABI","message":"ਦਿਨ ਬਿਤਾਉਣ ਲਈ!"},{"language":"KAZAKH","message":"Күнді өткізу үшін!"},{"language":"KOREAN","message":"하루를 지나치려면!"},{"language":"SPANISH","message":"¡Para pasar el día!"},{"language":"AMHARIC","message":"ቀኑን ለማሳለፍ!"},{"language":"GEORGIAN","message":"დღის გასატარებლად!"},{"language":"LITHUANIAN","message":"Praleisti dieną!"},{"language":"ENGLISH","message":"Spend the day!"}],"usergen":False,"message":"seize the day!","language":"ENGLISH","endmessage":"Spend the day!"}
    response = client.post("/rounds", json=round_data)
    assert response.status_code == 200
    response_json = response.get_json()
    assert response_json["status"] == "success"
